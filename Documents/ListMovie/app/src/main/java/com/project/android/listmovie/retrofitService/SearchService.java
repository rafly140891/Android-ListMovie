package com.project.android.listmovie.retrofitService;

import android.os.Parcel;
import android.os.Parcelable;

import com.project.android.listmovie.BuildConfig;
...
public class SearchService {
    ...
    public static class Result {
        ...
        public String toString() {
            return "Result { " + "Search=" + Search + ", totalResults='" + totalResults + '\'' + ", Response='" + Response + '\'' + '}';
        }
    }
    ...
    private static void setOmdbApi() {
        if (sOmdbApi == null) {
            ...
            httpClient.addInterceptor(new Interceptor() {
                ...
                public Response intercept(Chain chain) throws IOException {
                    ...
                    HttpUrl url = originalHttpUrl.newBuilder().addQueryParameter("apikey", BuildConfig.API_KEY).build();
